...
uploadImage(event:any): void{
  if (this.studentId) {
    ...
    .subscribe({
      next:(sucessResponce) => {
        this.student.profileimageUrl =sucessResponce;
        this.setImage();
        this.snackbar.open('Profile image uploaded sucessfuilly',undefined,{
          duration: 2000
        });
  },
  error: (responce) =>  {
...
this.displayProfileimageUrl ='/assets/download.png';
  }
}
}
